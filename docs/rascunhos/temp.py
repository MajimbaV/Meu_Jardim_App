...
def main(page: ft.Page):
    ...
    # --- PERSISTÊNCIA LOCAL ---
    CONFIG_FILE = "config_automacoes.json"
    ...
    def criar_bloco_automacao(pino_rele, txt_timer, txt_hora, buttons_dict, switch_componente):
        ...
        for d in dias_semana:
            ...
            container_chip = ft.Container(
                ...
                height=32,
                border_radius=6,
                border=ft.border.Border(left=ft.border.BorderSide(1, "white30"), right=ft.border.BorderSide(1, "white30"), top=ft.border.BorderSide(1, "white30"), bottom=ft.border.BorderSide(1, "white30")),
                bgcolor="transparent",
                    ...
                    if pino in dados_dict:
                        ...
                        for dia, container_obj in btns_dict.items():
                            if dia in automacoes[pino]["dias_agenda"]:
                                ...
                                container_obj.border = ft.border.Border(left=ft.border.BorderSide(1, "blue"), right=ft.border.BorderSide(1, "blue"), top=ft.border.BorderSide(1, "blue"), bottom=ft.border.BorderSide(1, "blue"))
                            else:
                                container_obj.bgcolor = "transparent"
                                container_obj.border = ft.border.Border(left=ft.border.BorderSide(1, "white30"), right=ft.border.BorderSide(1, "white30"), top=ft.border.BorderSide(1, "white30"), bottom=ft.border.BorderSide(1, "white30"))
